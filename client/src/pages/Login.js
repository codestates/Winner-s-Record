...
export default function Login() {
  ...
  const handleLogin = () => {
    ...
    axios
      .post(
        "https://server.winners-record.click/auth/login",
        { email, password },
  ...
  const handleNaver = () => {
    axios
      .get("https://server.winners-record.click/auth/naver/login")
      .then((res) => {
  ...
  const handleGoogle = () => {
    axios
      .get("https://server.winners-record.click/auth/google/login")
      .then((res) => {
        console.log(res.data);
      })
      .catch((err) => {
