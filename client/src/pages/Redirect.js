  ...
  useEffect(() => {
    async function login() {
      ...
      const result = await axios.post(
        `https://kauth.kakao.com/oauth/token?grant_type=authorization_code&client_id=${process.env.REACT_APP_KAKAO_ID}&redirect_uri=http://http://winner-s-record.click/redirect&code=${authorizationCode}`
      );
