...
export default function EditUserInfo({ editHandler }) {
  ...
  const handleOnblurName = () => {
    ...
    axios
      .post("https://server.winners-record.click/auth/nickname", { nickname })
      .then((res) => {
  ...
  const handleOnblurPassword = () => {
    ...
    axios
      .post(
        "https://server.winners-record.click/auth/password",
  ...
  const handleEditName = () => {
    ...
    axios
      .put(
        "https://server.winners-record.click/auth",
  ...
  const getUserInfo = () => {
    ...
    axios
      .get("https://server.winners-record.click/auth/me", {
